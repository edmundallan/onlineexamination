...
<div class="col-md-10">
<a href="mailto:elearning@umu.ac.ug" style="color:#000000">elearning@umu.ac.ug</a><br /><br />
...
<div class="form-group"> 
<textarea rows="5" cols="8" name="feedback" class="form-control" placeholder="Write your message here..."></textarea>
</div>
